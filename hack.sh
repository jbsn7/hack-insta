...
echo -e    "\e[91m"  
echo " "  
figlet -f Bloody hack-insta | lolcat

    echo " "
    echo -e "$Red                                 ⫸ Coded by$Yellow jbsn7$Red ⫷\033[0m"
    echo -e "$Red                               ⫸$Purple spyeye jbsn7 Hackers$Red ⫷\033[0m"
echo " "
echo -e " $Green     |---------------------------------------------------------------------|"
...
echo " "
   ...
   if [ $ch -eq 1 ];then
        ...
        cd $HOME
        rm -rf hack-insta
        git clone https://github.com/jbsn7/hack-insta
        cd hack-insta
        bash hack-insta.sh
